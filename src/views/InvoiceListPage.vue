  ...
  <div class="verification-container">
      ...
      <div class="filter-rows">
        ...
        <div class="filter-row">
          <div class="filter-item">
            <span class="filter-label">发票号</span>
            <a-input v-model="formData.invoiceNumber" placeholder="请输入" />
          </div>
          <div class="filter-item">
            <span class="filter-label">客户名称</span>
            <a-input v-model="formData.customerName" placeholder="请输入" />
          </div>
          <div class="filter-item">
        ...
        <div class="filter-row" v-show="isExpanded">
          <div class="filter-item">
            <span class="filter-label">开票日期</span>
            <a-range-picker 
          ...
          <div class="filter-item">
            <span class="filter-label">发票类型</span>
            <a-select v-model="formData.invoiceType" placeholder="全部">
              <a-option value="全部">全部</a-option>
        ...
        <div class="filter-row" v-show="isExpanded">
          <div class="filter-item">
            <span class="filter-label">开票金额</span>
            <div style="display: flex; width: 100%;">
              <a-input v-model="formData.amountMin" placeholder="最小值" style="margin-right: 8px;" />
              <span style="line-height: 32px; padding: 0 8px;">-</span>
              <a-input v-model="formData.amountMax" placeholder="最大值" />
            </div>
          </div>
          <div class="filter-item">
            <span class="filter-label">税率</span>
            <a-select v-model="formData.taxRate" placeholder="全部">
              <a-option value="全部">全部</a-option>
    ...
    <div class="action-container">
      ...
      <div class="action-right">
        ...
        <a-button @click="handleAddInvoice">
      ...
      >
        ...
        <template #operations="{ record }">
          <div class="operation-buttons">
            ...
            <a-button type="text" size="small" @click="handleDownloadInvoice(record)" v-if="record.status === '已开票'">
              下载发票
            </a-button>
            <a-button type="text" size="small" @click="handleCancelInvoice(record)" v-if="record.status === '未开票'">
              取消申请
            </a-button>
          </div>
        </template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const formData = reactive({
      ...
      customerName: "", // 客户名称
      referenceNo: "", // 业务参考号
      invoiceDate: [] as (string | number | Date)[], // 开票日期
      status: "", // 状态
      invoiceType: "", // 发票类型
      amountMin: "", // 开票金额最小值
      amountMax: "", // 开票金额最大值
    ...
    const invoiceList = reactive([
      {
        id: 1,
        invoiceNumber: "FP202503001",
        customerName: "上海兴平国际物流有限公司",
        referenceNo: "REF001",
        ...
        taxRate: "6%",
        taxAmount: "630.00",
        totalAmount: "11,130.00",
        updateTime: "2025-03-01 14:30:25"
      },
      {
        id: 2,
        invoiceNumber: "FP202503002",
        ...
        taxRate: "3%",
        taxAmount: "246.00",
        totalAmount: "8,446.00",
        updateTime: "2025-03-02 09:15:32"
      },
      {
        id: 3,
        invoiceNumber: "FP202503003",
        customerName: "广州海运物流有限公司",
        referenceNo: "REF003",
        invoiceDate: "",
        status: "未开票",
        invoiceType: "增值税专用发票",
        ...
        taxRate: "9%",
        taxAmount: "1,377.00",
        totalAmount: "16,677.00",
        updateTime: "2025-03-03 11:42:18"
      },
      {
        id: 4,
        invoiceNumber: "FP202503004",
        customerName: "青岛展海国际货运代理有限公司",
        referenceNo: "REF004",
        ...
        taxRate: "6%",
        taxAmount: "408.00",
        totalAmount: "7,208.00",
        updateTime: "2025-03-04 16:20:45"
      },
      {
        id: 5,
        invoiceNumber: "FP202503005",
        customerName: "厦门海陆空国际物流有限公司",
        referenceNo: "REF005",
        invoiceDate: "",
        status: "未开票",
        invoiceType: "增值税专用发票",
        ...
        taxRate: "13%",
        taxAmount: "1,612.00",
        totalAmount: "14,012.00",
        updateTime: "2025-03-05 10:05:37"
      }
    ]);
    ...
    const handleExportList = () => {
      Message.success("正在导出发票列表数据");
    };

    // 申请开票
    const handleAddInvoice = () => {
      Message.success("打开申请开票表单");
    };

    // 查看详情
    const handleViewDetail = (record: any) => {
      Message.info(`查看发票详情: ${record.invoiceNumber}`);
    };

    // 下载发票
    const handleDownloadInvoice = (record: any) => {
      Message.success(`下载发票: ${record.invoiceNumber}`);
    };

    // 取消申请
    const handleCancelInvoice = (record: any) => {
      Message.info(`取消发票申请: ${record.invoiceNumber}`);
    };
