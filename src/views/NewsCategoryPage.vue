<template>
  <div class="verification-container">
    <h2 class="page-title">资讯类别管理表</h2>
      ...
      <div class="filter-rows">
        ...
        <div class="filter-row">
          <div class="filter-item">
            ...
            <a-input v-model="formData.description" placeholder="请输入" />
          </div>
          <div class="filter-item">
            <span class="filter-label">语言</span>
            <a-select v-model="formData.language" placeholder="全部">
              <a-option value="">全部</a-option>
              <a-option value="CN">CN</a-option>
              <a-option value="JP">JP</a-option>
              <a-option value="CN_JP">CN_JP</a-option>
            </a-select>
          </div>
          <div class="filter-item">
...
export default defineComponent({
  ...
  setup() {
    ...
    const categoryList = reactive([
      {
        ...
        description: "NEWS",
        language: "JP",
        createdTime: "2024-12-05 20:23:39",
        creator: "chuck.g@newhappy2002.com",
        status: "启用"
      },
      {
        id: 2,
        description: "船スケジュール",
        language: "JP",
        createdTime: "2024-12-05 20:23:33",
        creator: "chuck.g@newhappy2002.com",
        status: "启用"
      },
      {
        ...
        description: "仓储配送服务",
        language: "CN_JP",
        createdTime: "2024-11-11 11:35:04",
        creator: "chuck.g@newhappy2002.com",
        status: "启用"
      },
      {
        ...
        description: "报关报检服务",
        language: "CN_JP",
        createdTime: "2024-11-11 11:34:55",
        creator: "chuck.g@newhappy2002.com",
        status: "启用"
      },
      {
        ...
        description: "海运服务",
        language: "CN_JP",
        createdTime: "2024-11-11 11:34:35",
        creator: "chuck.g@newhappy2002.com",
        status: "启用"
      },
      {
        ...
        description: "最新资讯",
        language: "CN",
        createdTime: "2024-11-11 11:35:28",
        creator: "chuck.g@newhappy2002.com",
        status: "启用"
      },
      {
        ...
        description: "系统公告",
        language: "CN_JP",
        createdTime: "2024-11-11 11:35:33",
        creator: "chuck.g@newhappy2002.com",
        status: "启用"
      },
      {
        ...
        description: "大件运输服务",
        language: "CN",
        createdTime: "2024-11-11 11:35:15",
        creator: "chuck.g@newhappy2002.com",
        status: "禁用"
      },
      {
        ...
        description: "空运服务",
        language: "CN",
        createdTime: "2024-11-11 11:34:42",
        creator: "chuck.g@newhappy2002.com",
        status: "禁用"
      }
    ]);
    ...
    const handleAddCategory = () => {
      Message.success("打开新增资讯类别表单");
    };

    // 编辑类别
    const handleEdit = (record: any) => {
      Message.info(`编辑资讯类别：${record.description}`);
    };

    // 删除类别
    const handleDelete = (record: any) => {
      Message.info(`删除资讯类别：${record.description}`);
    };

    // 禁用/启用类别
    const handleToggleStatus = (record: any) => {
      const newStatus = record.status === '启用' ? '禁用' : '启用';
      Message.info(`将资讯类别 ${record.description} 状态修改为 ${newStatus}`);
    };
